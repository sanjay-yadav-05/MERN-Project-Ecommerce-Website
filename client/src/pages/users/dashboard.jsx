...
//                 <UserMenu />
//                 {/* right section */}
//                 <div className='w-5/6 border-2 border-black flex items-center justify-center h-full  '>
...
//                 {/* Right Section */}
//                 <div className="flex-1 border-2 border-gray-300 rounded-lg shadow-lg bg-white flex items-center justify-center">
//                     <div className="w-3/5 h-3/4 border-2 border-gray-200 rounded-lg flex flex-col gap-4 p-6">
//                         {/* Header */}
